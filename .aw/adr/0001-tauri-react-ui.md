...
The application needs a cross-platform desktop UI with a node-graph Visual Canvas, split-screen panel layouts (Blender-style), a terminal panel, a diff viewer, and a markdown renderer. Two stacks were considered:
...
- Negative: UI responsiveness is gated by IPC bridge latency, though this is negligible for the Visual Canvas interaction patterns we need.
